...
let descending = ["Sakardu", "Lolosar Lake", "Deosai", "Pasu cones"];
{
    descending.sort((a, b) => b.localeCompare(a));
    console.log(descending);
}
//Sort your array so it’s stored in alphabetical order. Print the array to show that its order has been changed.
let vacation2 = ["Sakardu", "Lolosar Lake", "Deosai", "Pasu cones"];
{
    vacation2.sort();
    console.log(vacation2);
}
//Sort to change your array so it’s stored in reverse alphabetical order. Print the list to show that its order has changed.
let reverseVacation = ["Sakardu", "Lolosar Lake", "Deosai", "Pasu cones"];
