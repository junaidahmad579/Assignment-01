...
let person = ["Junaid", "Faizan", "Khizar", "Hamad", "Jamshaid", "Ahsan"];
{
...
let persons = ["Junaid", "Faizan", "Khizar", "Hamad", "Jamshaid", "Ahsan", "Usman", "Basit", "Shahbaz"];
{
...
//Add one new guest to the beginning of your array.
let newPersons = ["Junaid", "Faizan", "Khizar", "Hamad", "Jamshaid", "Ahsan", "Usman", "Basit", "Shahbaz"];
{
...
let newPerson = ["Hamza", "Junaid", "Faizan", "Khizar", "Hamad", "Jamshaid", "Ahsan", "Usman", "Basit", "Shahbaz"];
{
